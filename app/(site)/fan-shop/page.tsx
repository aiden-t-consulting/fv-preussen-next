...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: "54,95 €",
    badge: "Neu",
    bg: "from-[#2e7d32]/70 to-[#1b5e20]/80",
    accent: "#bbf7d0",
    icon: "🥋",
  },
  {
    ...
    category: "Kinder",
    price: "49,95 €",
    bg: "from-[#2e7d32]/50 to-[#a5d6a7]/30",
    accent: "#2e7d32",
    icon: "👕",
  },
  {
  ...
  },
  {
    ...
    category: "Accessoires",
    price: "4,95 €",
    bg: "from-[#2e7d32]/40 to-[#1b5e20]/60",
    accent: "#a5d6a7",
    icon: "🔑",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <h3 className="flex-1 text-sm font-bold text-gray-900 group-hover:text-[#2e7d32]">
          {product.name}
        </h3>
        <div className="mt-3 flex items-center justify-between">
          ...
          <span className="flex items-center gap-1 text-[10px] text-gray-400 group-hover:text-[#2e7d32]">
...
export default function FanShopPage() {
  return (
    <div className="min-h-screen bg-[#f8f7f5]">
      {/* ── Hero ──────────────────────────────────────────────────────────── */}
      <div className="relative overflow-hidden bg-gradient-to-br from-[#1e2030] via-[#1a2a1a] to-[#1b5e20]">
        {/* Background pattern */}
        <div
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <h1 className="mb-5 text-5xl font-bold text-white [font-family:var(--font-club)] lg:text-6xl">
                FV Preussen
                <span className="block text-[#a5d6a7]">Fan Shop</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 rounded-full bg-[#2e7d32] px-7 py-3.5 text-sm font-bold uppercase tracking-wider text-white transition-colors hover:bg-[#1b5e20]"
                >
            ...
            <div className="hidden lg:flex lg:justify-end">
              <div className="relative">
                <div className="flex h-72 w-72 items-center justify-center rounded-3xl bg-gradient-to-br from-[#2e7d32]/40 to-[#1b5e20]/60 backdrop-blur-sm border border-white/10 shadow-2xl">
                  <div className="flex flex-col items-center gap-4">
                    <span className="text-8xl">👕</span>
                    <div className="text-center">
                      <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#a5d6a7]">
                        Heimtrikot
                      </p>
                  ...
                  {/* Badge */}
                  <div className="absolute -right-3 -top-3 rounded-full bg-[#2e7d32] px-3 py-1.5 text-[11px] font-bold text-white shadow-lg">
                    NEU
                  </div>
                </div>
                {/* Floating price tag */}
                <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 rounded-2xl bg-white px-6 py-3 shadow-xl">
                  ...
                  <p className="text-center text-2xl font-bold text-[#2e7d32]">
                    49,95 €
                  </p>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-[1280px] px-4">
          <div className="grid grid-cols-2 divide-x divide-gray-100 lg:grid-cols-4">
            {TRUST_ITEMS.map(({ icon: Icon, title, desc }) => (
              ...
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#2e7d32]/10">
      ...
      <div className="mx-auto max-w-[1280px] px-4 py-10 lg:py-12">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#2e7d32] to-[#1b5e20] p-8 lg:p-12">
          <div
          ...
          <div className="relative flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
            <div>
              <p className="mb-1 text-[11px] font-bold uppercase tracking-widest text-[#a5d6a7]">
                Neue Saison
              </p>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="shrink-0 flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-bold text-[#2e7d32] transition-colors hover:bg-gray-100"
            >
              <ShoppingBag className="h-4 w-4" />
              Jetzt shoppen
            </a>
          ...
          <div className="flex gap-1 overflow-x-auto py-3">
            {CATEGORIES.map((cat) => (
              <a
                ...
                className={
                  cat.active
                    ? "shrink-0 rounded-full bg-[#2e7d32] px-4 py-2 text-[12px] font-bold uppercase tracking-wider text-white"
                    : "shrink-0 rounded-full border border-gray-200 px-4 py-2 text-[12px] font-semibold uppercase tracking-wider text-gray-600 transition-colors hover:border-[#2e7d32] hover:text-[#2e7d32]"
                }
              >
                {cat.label}
              </a>
      ...
      <div id="produkte" className="mx-auto max-w-[1280px] px-4 py-12 lg:py-16">
        <div className="mb-8 flex items-end justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wider text-[#2e7d32] hover:underline"
          >
            Alle Produkte
            <ExternalLink className="h-3 w-3" />
          </a>
      ...
      <div className="mx-auto max-w-[1280px] px-4 pb-12 lg:pb-16">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex h-48 items-end overflow-hidden rounded-2xl bg-gradient-to-br from-[#2e7d32] to-[#1b5e20] p-6"
          >
            ...
            <div className="relative">
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#a5d6a7]">
                Kollektion
              </p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex h-48 items-end overflow-hidden rounded-2xl bg-gradient-to-br from-[#a5d6a7]/40 to-[#2e7d32]/60 p-6"
          >
            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-6xl opacity-30 transition-transform duration-500 group-hover:scale-110">
              ⭐
            </span>
            <div className="relative">
              <p className="text-[10px] font-bold uppercase tracking-widest text-[#1b5e20]">
                Nachwuchs
              </p>
              <h3 className="text-xl font-bold text-white [font-family:var(--font-club)]">
                Kinder
      ...
      <div className="border-t border-gray-200 bg-white">
        <div className="mx-auto max-w-[1280px] px-4 py-12 text-center">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#2e7d32]/10 mb-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full bg-[#2e7d32] px-8 py-3.5 text-sm font-bold uppercase tracking-wider text-white transition-colors hover:bg-[#1b5e20]"
          >
            <ShoppingBag className="h-4 w-4" />
