  ...
  if (status === "success") {
    return (
      <div className="flex flex-col items-center text-center py-12 gap-4">
        <div className="w-16 h-16 rounded-full bg-[#f1f8e9] flex items-center justify-center">
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
      ...
      <div>
        <label className="flex items-start gap-3 cursor-pointer">
          <input
            type="checkbox"
            className="mt-0.5 w-4 h-4 rounded accent-[#2e7d32]"
            {...register("privacy")}
          />
          <span className="text-sm text-gray-600">
            Ich stimme der{" "}
            <a href="/datenschutz" className="text-[#2e7d32] underline underline-offset-2" target="_blank">
